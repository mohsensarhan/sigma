...
class MockSMSAPI {
    ...
    this.templates = [
      {
        id: 'thank_you',
        name: 'Thank You',
        message: 'Thank you for your donation of {{amount}} {{currency}}! View your journey: {{journey_url}}',
        variables: ['amount', 'currency', 'journey_url']
      },
      {
        id: 'step_1',
        name: 'Step 1 Notification',
        message: 'Your donation has been received! Step 1: Collection. View progress: {{journey_url}}',
        variables: ['journey_url']
      },
      {
        id: 'step_2',
        name: 'Step 2 Notification',
        message: 'Great news! Step 2: Processing complete. Step 3: Transportation. View: {{journey_url}}',
        variables: ['journey_url']
      },
      {
        id: 'step_3',
        name: 'Step 3 Notification',
        message: 'Your donation is on the move! Step 3: Transportation. Step 4: Distribution. View: {{journey_url}}',
        variables: ['journey_url']
      },
      {
        id: 'step_4',
      ...
      },
      {
        ...
        message: 'Success! Your donation has been delivered. Thank you for making a difference! View: {{journey_url}}',
        variables: ['journey_url']
      },
      {
        id: 'journey_complete',
        name: 'Journey Complete',
        message: 'Your donation journey is complete! You provided {{meals}} meals and helped {{lives}} people. Thank you!',
   ...
   */
  async sendSMSTemplate(to: string, templateId: string, variables: Record<string, string>): Promise<MockSMS> {
   ...
   */
  async sendThankYouSMS(to: string, amount: number, currency: string, journeyUrl: string): Promise<MockSMS> {
  ...
  getStats() {
    ...
    const sent = this.messages.filter(m => m.status === 'sent' || m.status === 'delivered').length;
